...
public class MainActivity extends CheckPermissionsActivity {
    ...
    private void get_air(String city) {
        ...
        Request request = new Request.Builder()
                // 拼接访问地址
                .url("https://devapi.qweather.com/v7/air/7d?key=0525359d1c154f7992018f543d50eea1&location=" + city)
                .build();
    ...
    private void get_weather(String area) {
        ...
        Request request = new Request.Builder()
                // 拼接访问地址
                .url("https://devapi.qweather.com/v7/weather/7d?key=0525359d1c154f7992018f543d50eea1&location=" + area)
                .build();
        client.newCall(request).enqueue(new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
